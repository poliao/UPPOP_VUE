            ...
            <div class="rightchild bg-white"> <!--login-->
                ...
                <form @submit.prevent="login">
                    ...
                    <div class="d-grid gap-1">
                        <button class="btn btn-custom d-flex justify-content-center align-items-center p-3 "
...
.leftchild {
    flex: 3;
    height: 100vh;
    /* ให้ความสูงของ .leftchild เต็มหน้าจอของผู้ใช้ (100vh) */
    background: center/cover no-repeat url('../assets/login/backgroudlogo-uppop.png');
    display: flex;
    justify-content: center;
    /* จัดตำแหน่งรูปพื้นหลังให้อยู่กึงกลางแนวตั้งและนอน */
    align-items: center;
    /* จัดตำแหน่งรูปพื้นหลังให้อยู่กึงกลางแนวตั้งและนอน */
}
...
.backgroud-logo {
    text-align: center;
    /* จัดตำแหน่งข้อความและโลโก้ในส่วนซ้ายให้อยู่กึงกลางแนวตั้งและนอน */
    display: flex;
    flex-direction: column;
    align-items: center;
    width: 45vh;
    /* ทำให้พื้นหลังรองรับหน้าจอ */
    max-height: 100%;
}
...
.rightchild {
    flex: 5;
    height: 100vh;
    /* ให้ความสูงของ .rightchild เต็มหน้าจอของผู้ใช้ (100vh) */
...
.details-login {
    ...
    align-items: center;
    margin-top: 1vh;
    /* ระยะห่างด้านบนของรายละเอียดการเข้าสู่ระบบ */
}
